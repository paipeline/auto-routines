---
name: commit-tests
description: Run pytest after every commit; if it fails, open a fix PR. — installed by auto-routines on 2026-05-10T18:56:21+02:00, iter-1. Invoked by git-hook trigger (on every git commit).
---
